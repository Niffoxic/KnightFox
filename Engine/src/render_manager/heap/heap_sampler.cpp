...
bool kfe::KFESamplerHeap::Initialize(const KFE_SAMPLER_HEAP_CREATE_DESC& desc)
{
...
_Use_decl_annotations_
bool kfe::KFESamplerHeap::Impl::Initialize(const KFE_SAMPLER_HEAP_CREATE_DESC& desc)
{
    //~ Validate inputs
