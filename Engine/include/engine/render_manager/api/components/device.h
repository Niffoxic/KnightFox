...
namespace kfe
{
	...
	public:
		...
		NODISCARD std::uint32_t GetRTVDescriptorSize() const noexcept;
		NODISCARD std::uint32_t GetDSVDescriptorSize() const noexcept;
		NODISCARD std::uint32_t GetCRUDescriptorSize() const noexcept;
